    ...
    <body>
        ...
        <div class="layout_left_menu">
            <ul id="menu">
                ...
                <li class="childUlLi">
                    <a href="#"  target="menuFrame"><i class="glyph-icon icon-home"></i>查询成绩</a>
                    <ul>
                       <!--  <li><a href="${pageContext.request.contextPath}/admin/MemberServlet?method=listByPage" target="menuFrame"> -->
                        <li><a href="studentmark.jsp" target="menuFrame">
                                <i class="glyph-icon icon-chevron-right"></i>查询</a>
                        </li>
                ...
                <li class="childUlLi">
                    ...
                    <ul>
                        ...
                        <li><a href="modifypasswordfirst.jsp" target="menuFrame">
